...
<div class="container">
	<p class="breadcrumb">
		<a href="/admin">Admin</a> &rsaquo; Edit Pourover Brew
	</p>
	<h1>Edit Pourover — {brew.bean_name}</h1>
	...
	<form method="POST" use:enhance class="brew-form">
		<div class="form-section">
			...
			<EquipmentAutocomplete
				...
				required
				initialId={brew.current_dripper_id?.toString() ?? ''}
				initialName={brew.dripper_name?.toString() ?? ''}
			/>
			...
			<div class="form-row">
				...
				<div class="form-group">
					...
					<input type="number" id="water_grams" name="water_grams" step="1" required value={brew.water_grams ?? ''} />
				</div>
			</div>
			...
			<div class="form-section">
				...
				<div class="form-row">
					<div class="form-group">
						...
						<select id="filter_type" name="filter_type">
							...
							<option value="paper" selected={brew.filter_type === 'paper'}>Paper</option>
							<option value="metal" selected={brew.filter_type === 'metal'}>Metal</option>
							<option value="cloth" selected={brew.filter_type === 'cloth'}>Cloth</option>
						</select>
					</div>
					<div class="form-group">
				...
				<div class="form-row">
					...
					<div class="form-group">
						...
						<input type="text" id="kettle" name="kettle" value={brew.kettle ?? ''} />
					</div>
				</div>
				...
				<div class="form-row">
					<div class="form-group">
						...
						<input type="number" id="bloom_time_seconds" name="bloom_time_seconds" step="1" value={brew.bloom_time_seconds ?? ''} />
					</div>
					<div class="form-group">
						<label for="bloom_water_grams">Bloom Water (g)</label>
						<input type="number" id="bloom_water_grams" name="bloom_water_grams" step="1" value={brew.bloom_water_grams ?? ''} />
					</div>
				</div>
				...
				<div class="form-row">
					<div class="form-group">
						...
						<input type="number" id="pour_count" name="pour_count" value={brew.pour_count ?? ''} />
					</div>
					<div class="form-group">
						<label for="pour_technique">Pour Technique</label>
						<input type="text" id="pour_technique" name="pour_technique" value={brew.pour_technique ?? ''} />
					</div>
				</div>
